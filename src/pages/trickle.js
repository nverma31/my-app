...
const introText = { brief: 'Design an interactive installation that raises awareness about Privacy Issues.', intro: 'The installation raises awareness about the issue of data privacy and theft. When someone connects to our fake public Wi-Fi network, their online activity is tracked and our installation shows a trickling down pattern using lights and sounds, symbolising data theft.', client:'Project Info',company:"Part of the Reactive Spaces course during my Masters. ",what:"I was responsible for prototyping, coding, fabrication, and installation of the entire concept.",when:"Sep 2016",imageurl: Hero};
const sectioin1 = { num: '01', title: 'The Concept.', text: 'When someone connects to our fake public Wi-Fi network, their online activity is tracked and our installation shows a trickling down pattern using lights. The installation gets activated as it identifies when a person who has been compromised passes near the installation. The installation uses different colors of lights and sounds that relate to different apps and services that are identified in the person\'s online activity.'};
const sectioin2 = { num: '02', title: 'Bringing it to Life', text: 'Our project had two major components: a twin wifi network for people to connect to so that we could track their data and a responsive light installation that behaves based on the tracked data.'};
const sectioin3 = { num: '03', title: 'Site Installation', text: 'We wanted to position our installation in a public Wi-Fi environment and we chose a nearby Starbucks. Prior to actually filming the video, we did video storyboard for the whole narrative. It was rewarding to see the lighting interaction  work and the user’s movements were being tracked.'};
